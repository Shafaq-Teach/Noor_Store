...
export const AdminScreen = () => {
  ...
  const handleSaveStoreSettings = async (e) => {
    ...
    try {
      ...
      if (ok) {
        setSettingsSaveMsg({ 
          type: 'success', 
          text: '✅ دۇكان ئۇچۇرلىرى مۇۋەپپەقىيەتلىك ساقلاندى ۋە پۈتۈن سىستېمىدا يېڭىلاندى!' 
        });
      } else {
  ...
  // AI Assistant Key State & Handler
              ...
              <div className="p-3.5 rounded-2xl border bg-black/5 dark:bg-white/5 space-y-1.5" style={{ borderColor: themeColors.border }}>
                <div className="flex items-center justify-between">
                  <span className="font-bold flex items-center gap-1.5 text-sky-500">
                    <img src={getAssetUrl('/icons/telegram_3d.png')} className="w-5 h-5 rounded-md object-contain inline-block" alt="Telegram" />
